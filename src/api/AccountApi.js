...
export class AccountApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the accountLogintestPost operation.
     * @callback moduleapi/AccountApi~accountLogintestPostCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
    ...
    /**
     * @param {module:api/AccountApi~accountLogintestPostCallback} callback The callback function, accepting three arguments: error, data, response
     */
    accountLogintestPost(callback) {
